...
import {
  GetInterviewExpiriences,
  OpenInterviewExpirience,
} from "@/helpers/student/api";
import toast from "react-hot-toast";
import loadingImg from "@/components/Faculty/loadingSpinner.svg";
import Loader from "@/components/Loader/loader";
const InterviewExpiriencePage = () => {
  const [interviewExpirienceData, setInterviewExpirienceData] = useState<
    InterviewExperience[]
  >([]);
                ...
                <TableRow key={index}>
                  ...
                  <TableCell>
                    <div
                      ...
                      onClick={() =>
                        handleOpenInterviewExpirience(item.filename)
                      }
                    >
                      {item.studentName}
                    </div>
