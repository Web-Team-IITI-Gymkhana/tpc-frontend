...
const EachJobPage = async ({ params }: Props) => {
    const EachJob = await fetchEachJob(cookies()?.get("accessToken")?.value, params.jobId);
    ...
    return (
        <div className="m-10 bg-white p-5 border-2 rounded-xl">
            ...
            <div className="text-gray-600 font-medium text-md  text-sm mt-4 mb-2">{"Work From Home"}</div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 text-sm">
                <div>
                    <div className="text-gray-500 font-semibold my-2">Start Date</div> <div>3rd Jan 2024</div>
                </div>
                <div>
                    <div className="text-gray-500 font-semibold my-2">Duration</div> <div>3 Months</div>
                </div>
                <div>
                    <div className="text-gray-500 font-semibold my-2">Stipend</div> <div>Rs 45000</div>
                </div>
                <div>
                    <div className="text-gray-500 font-semibold my-2">Apply By</div> <div>1st Jan 2024</div>
                </div>
            </div>
            ...
            <div>
                ...
                <ul className="list-disc mx-10">
                    ...
                    <li>
                        Take ownership of the application and work alongside backend and database engineers to deliver
            ...
            <div>
                ...
                <ul className="list-disc mx-10">
                    ...
                    <li>
                        can work from 8:00 pm - 2:00 am Indian Standard Time (as the company is based outside of India &
                        their local work timings are 9:30 am - 3:30 pm Eastern Standard Time)
                    </li>
