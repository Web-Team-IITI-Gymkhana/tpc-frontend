    ...
    <div className="min-h-screen bg-gray-50">
      <Providers>
        <div className="min-h-screen flex">
          ...
          <div className="hidden lg:flex lg:w-[560px] lg:flex-col lg:justify-center lg:px-12 bg-gradient-to-br from-slate-900 to-gray-900 lg:fixed lg:top-0 lg:left-0 lg:h-screen lg:z-10">
