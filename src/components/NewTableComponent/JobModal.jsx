                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {jobData.recruiter.user.contact}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {jobData.companyDetailsFilled.website}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                          ...
                          <TableCell>
                            {jobData.companyDetailsFilled.size}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                          ...
                          <TableCell>
                            {jobData.companyDetailsFilled.annualTurnover}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                          ...
                          <TableCell>
                            {jobData.companyDetailsFilled.socialMediaLink}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {jobData.recruiterDetailsFilled.landline}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                    ...
                    <Table>
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>
                            {jobData?.selectionProcedure?.selectionMode}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            <Table>
                              ...
                              <TableBody>
                                {jobData?.selectionProcedure?.tests.map(
                                  (test) => (
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            <Table>
                              ...
                              <TableBody>
                                {jobData?.selectionProcedure?.interviews.map(
                                  (interview) => (
                            ...
                            <Table>
                              <TableBody>
                                <TableRow>
                                  ...
                                  <TableCell>
                                    {
                                      jobData?.selectionProcedure?.requirements
                                        ?.numberOfMembers
                                    }
                                  </TableCell>
                                </TableRow>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {jobData?.selectionProcedure?.others}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {new Date(
                              jobData.offerLetterReleaseDate,
                            ).toLocaleString()}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell>
                            {new Date(jobData.joiningDate).toLocaleString()}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell
                      ...
                      <TableBody>
                        {jobData.jobCoordinators.map((coordinator) => (
                          <TableRow key={coordinator.id}>
                            ...
                            <TableCell>
                              {coordinator.job.company.name}
                            </TableCell>
                            <TableCell>
                              {coordinator.job.season.year} -{" "}
                              {coordinator.job.season.type}
                            </TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                      ...
                      <TableBody>
                        {jobData.events.map((event) => (
                          <TableRow key={event.id}>
                            ...
                            <TableCell>
                              {event.visibleToRecruiter.toString()}
                            </TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                      ...
                      <TableBody>
                        {jobData.salaries.map((salary) => (
                          <TableRow key={salary?.id}>
                            ...
                            <TableCell>
                              {salary?.programs?.join(", ")}
                            </TableCell>
                            <TableCell>
                              {salary?.facultyApprovals?.join(", ")}
                            </TableCell>
                            <TableCell>
                              {salary?.categories?.join(", ")}
                            </TableCell>
