...
export default function DeleteStudentModal({memberId,isDeleteModalOpen}:Props) {
                ...
                <form>
                    <div className="grid w-full items-center gap-4">
                        <div className="flex flex-col space-y-1.5">
                            <CardDescription>Type <b>Delete</b> To Confirm The Delete</CardDescription>
                            <Input onChange={(e)=>{
                            ...
                            }} id="name" placeholder="Name of your project" className="mt-2 " />
                        </div>
