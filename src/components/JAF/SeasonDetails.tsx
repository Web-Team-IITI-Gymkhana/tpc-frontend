...
const SeasonDetails = ({
  ...
  const [selectedSeasonInfo, setSelectedSeasonInfo] = useState<{
    type: string;
    year: string;
  } | null>(null);
        ...
        >
          ...
          >
            <Select
              ...
              notFoundContent={
                loading ? "Loading seasons..." : "No seasons available"
              }
              style={{ width: "100%" }}
            />
          </Form.Item>
          ...
          {selectedSeasonInfo ? (
            ...
            >
              <Space
                ...
                style={{ width: "100%" }}
              >
                {(selectedSeasonInfo.type.toLowerCase() === "intern"
                  ? Intern
                  : FullTime
                ).map((tc, index) => (
                  <div
            ...
            >
              <Text style={{ color: "#6b7280", fontSize: 14 }}>
                Please select a recruitment season to view the terms and
                conditions
              </Text>
            </div>
          )}
          ...
          >
            ...
            >
              ...
              >
                <Text
                  strong
                  style={{ color: values.terms ? "#1890ff" : "#374151" }}
                >
