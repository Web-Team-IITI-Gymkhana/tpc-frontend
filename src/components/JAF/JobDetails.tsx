            ...
            <Row gutter={24}>
                <Col span={12}>
                    <Form.Item label="Job Title">
                        <Input name="role" placeholder="Job Title" onChange={handleChange} value={values.role} />
                    </Form.Item>
                </Col>
                <Col span={12}>
                    <Form.Item
            ...
            <Row gutter={24}>
                <Col span={12}>
                    <Form.Item label="Skill">
                        <Input name="skills" placeholder="Skill" onChange={handleChange} value={values.skills} />
                    </Form.Item>
                </Col>
                <Col span={12}>
            ...
            <Row gutter={24}>
                <Col span={12}>
                    <Form.Item label="Location">
                        <Input name="location" placeholder="Location" onChange={handleChange} value={values.location} />
                    </Form.Item>
                </Col>
                <Col span={12}>
                                ...
                                <Row gutter={24}>
                                    <Col span={12}>
                                        <Form.Item
                                            ...
                                            rules={[{ required: true, message: "Required" }]}
                                        >
                                            <Select placeholder="Please select" options={interviewType} />
                                        </Form.Item>
                                    </Col>
                                    <Col span={12}>
                                        <Form.Item
