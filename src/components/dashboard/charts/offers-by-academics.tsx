...
import { Bar, BarChart, Line, LineChart, CartesianGrid, XAxis, YAxis, Tooltip, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts'
...
export function OffersByAcademics({ viewType, data = {}, seasonType }: OffersByAcademicsProps) {
  ...
  if (viewType === 'table') {
    ...
    // Pie Chart View
      ...
      const pieData = Object.entries(data).map(([cpi, stats]) => ({
        name: `CPI ${cpi}`,
