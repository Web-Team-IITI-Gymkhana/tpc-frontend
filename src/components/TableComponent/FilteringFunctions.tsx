...
export const handleFilterChange = (columnId: string, value: string, filters: any, setFilters: any) => {
    ...
    if (existingFilterIndex === -1) {
        ...
        setFilters((prevFilters: any) => prevFilters.filter((filter: any) => filter.columnId !== columnId));
    }
};

export const handleOperatorChange = (columnId: string, operator: "eq" | "lt" | "gt", setFilters: any) => {
    setFilters((prevFilters: any) =>
        prevFilters.map((filter: any) => (filter.columnId === columnId ? { ...filter, operator } : filter)),
    );
};
