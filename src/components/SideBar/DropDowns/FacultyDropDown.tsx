...
export function FacultyDropDown({ userRole }: Props) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    {value ? faculties.find((faculty) => faculty.value === value)?.label : "Select Event"}
                ...
                <Command>
                    ...
                    <CommandGroup>
                        {faculties.map((faculty: Faculties) => (
                            ...
                            >
                                <Link className="flex w-full" href={`/${userRole}/faculty${faculty.path}`}>
                                    {faculty.label}
                                </Link>
                            </CommandItem>
                        ))}
